...
def cadastrar(lista_de_usuarios):
    ...
    while True:
        ...
        for palavra in nome_lista:
            nome_sem_espaco=nome_sem_espaco+palavra
        if nome_sem_espaco.isalpha()==True:
            break
        else:
                ...
                if resposta=="1":
                    ...
                    while True:
                        ...
                        if nome_sem_espaco.isalpha()==True:
                            ...
                            print("Digite um nome válido!")
                            novo_nome=input("Nome: ").upper()
                    novo_nome2=input("Digite o nome novamente: ").upper()
                    ...
                    novo_cpf=input("Cpf: ")
                    while True:
                        if len(novo_cpf)==11 and novo_cpf.isnumeric()==True:
                            valido=True
